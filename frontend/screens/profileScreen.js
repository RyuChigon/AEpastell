...
export default function Profile({ navigation }) {
    return (
      ...
      <ImageBackground style={{flex: 1, flexDirection: "column", justifyContent: "space-between", alignItems:"center"}} source={require("../images/MAIN/Main_background1.jpg")} resizeMode="cover">
        <TouchableOpacity style={styles.edit_profile} onPress={()=>navigation.goBack()}>
            ...
            <View>
              ...
              <View style={{flexDirection: "row"}}>
                ...
                <View style={{backgroundColor: 'skyblue'}}>
                  <Button title="Get Number" onPress={()=>{navigation.navigate('Setting')}}/>
                </View>
              </View>
              ...
              <View style={{backgroundColor: 'skyblue'}}>
                <Button style={{color: 'blue', bottom: '5%'}} title="Save Settings" onPress={()=>{navigation.navigate('Setting')}}/>
              </View>
            </View>
          </View>
        </View>
