...
export default function Setting({navigation}) {
  ...
  return (
    ...
    <ImageBackground style={{flex: 1, alignItems: "center"}} source={require("../../../images/MAIN/Main_background1.jpg")} resizeMode="cover">
      <TouchableOpacity style={{marginRight: "95%"}} onPress={()=>navigation.goBack()} >
      ...
      <View style={styles.edit_profile}>
        <Button title="Edit Profile" onPress={()=>{navigation.navigate("ProfileScreen", {screenComponent: <Setting/>})}}/>
      </View>
